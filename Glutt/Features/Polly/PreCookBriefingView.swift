...
struct PreCookBriefingView: View {
    ...
    private var bottomBar: some View {
        VStack(spacing: 10) {
            // The watchfulness picker lived here and only ever appeared when a
            // pair of wearable camera was connected. It asked how much Chef should watch
            // you unprompted, which is a question that only makes sense about a
            // camera on your face.
