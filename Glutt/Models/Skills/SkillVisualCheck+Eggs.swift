...
extension SkillVisualCheck {
    ...
    static let eggsCrack = SkillVisualCheck(
        id: "eggs.crack.technique",
        assessmentMode: .process,
        framingInstruction:
            "Crack one egg slowly, looking down at your hands and the bowl.",
        setupNeeds: ", with an egg and a bowl in front of you.",
        requiredVisibility: [.ingredient],
        helpfulVisibility: [.thumb, .workSurface, .tool],
        parts: [
            SkillCheckPart(region: .workSurface, label: "Tapped on something flat"),
            SkillCheckPart(region: .thumb, label: "Thumbs opening the crack"),
            SkillCheckPart(region: .ingredient, label: "Yolk whole, no shell in the bowl"),
        ],
        rubric: SkillVisualRubric(
            subject: "a cook cracking an egg into a bowl",
            targetTechnique: [
                "One firm tap on a flat surface, producing a clean fracture near the middle.",
                "Both thumbs go into the crack and pull the shell apart.",
                "The shell opens without a thumb being driven down into the yolk.",
            ],
            acceptableVariations: [
                "Cracking on the edge of a bowl. Very good cooks do this constantly and it is "
                    + "not dangerous or wrong. A flat surface just gives a cleaner break, so "
                    + "prefer it for this lesson without ever calling the other way a mistake.",
                "One hand or two.",
                "Two taps rather than one, if the first was gentle.",
                "Cracking into a cup first, which is what a careful cook does when a stray "
                    + "shell would be hard to fish out.",
                "A bit of white running down the outside of the bowl.",
            ],
            rankedMistakes: [
                SkillCoachableMistake(
                    key: "crushedShell",
                    observation:
                        "The egg is being squeezed or hit hard enough that the shell caves in "
                        + "rather than cracking in a line.",
                    correction:
                        "Use a lighter tap, then open the crack with your thumbs instead of "
                        + "squeezing the egg.",
                    rationale:
                        "A crushed shell breaks into small pieces, and small pieces are the "
                        + "ones that end up in the bowl and are impossible to find.",
                ...
                SkillCoachableMistake(
                    key: "thumbThroughEgg",
                    observation:
                        "A thumb is pushing downward into the egg rather than outward against "
                        + "the shell, breaking the yolk.",
                    correction:
                        "Put your thumbs into the crack and pull the shell apart. Do not push "
                        + "them down into the egg.",
                    rationale:
                        "Pulling outward opens the shell like a hinge. Pushing down sends your "
                        + "thumb straight through whatever is underneath it.",
                    severity: .outcomeCost,
                    requiresVisible: [.thumb, .ingredient]
                ),
            ],
            safetySignals: [
                "Raw egg on a surface where ready to eat food is being prepared, with no "
                    + "sign of it being cleaned.",
            ],
            supportedEquipment: ["Any bowl", "Any flat work surface"],
            unsupportedEquipment: [],
            notVisuallyAssessable: eggsCannotBeSeen + [
                "Small shell fragments in the bowl, which are often too small to see at "
                    + "this resolution. Ask rather than claiming the bowl is clear.",
            ],
            confidenceFloor: 0.55,
            passSummary: "Clean crack, yolk intact.",
            variationSummary: "Their own way of cracking it, and it opened cleanly."
        ),
        retryFraming: "Do another one and keep your hands and the bowl in view as you go."
    )
