...
enum PollyPromptBuilder {
    ...
    private static func seeingRules(seesContinuously: Bool, watchfulness: ChefWatchfulness) -> String {
        ...
        - SAY WHAT YOU SAW, THEN MOVE. Looking is half of it; telling them what you saw is the
          ...
          pan is hot enough, the butter smells nutty — look, then open your reply with the verdict
        ...
        - NOT SEEING IT IS NOT THE SAME AS IT NOT BEING THERE, and once a look has come back
          ...
          seeing the pan or the board yet. Point me at them when you get a second, or if they are
